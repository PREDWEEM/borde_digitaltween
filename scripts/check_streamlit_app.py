"""Visita pública de Bordenave; comprueba la interfaz, no sólo una respuesta HTTP.
...
APP_URL = "https://nhfm7pn5fzkd5shigp2vyh.streamlit.app/"
HEADING = "Gemelo Digital · Lolium Bordenave"
            ...
            while time.monotonic() - started < MAX_WAIT_SECONDS:
                ...
                if ready:
                    if ready_since is None:
                        ...
                        return f"Bordenave operativo: indicadores y gráfico cargados ({seconds} s)."
                else:
                    ready_since = None
